...
CREATE PROCEDURE AddEmployee(
    ...
    select now() into t;
        ...
        call RegisterUser(UserID,passwd,LastName,FirstName,Address,city,State,email,rating,'employee');
    END//
...
#Obtain Sales Report for a Month
CREATE PROCEDURE GetSalesReport(
	mnth INT
    )
    BEGIN
    SELECT * FROM SALES WHERE MONTH(DatePurchase)=mnth;
    END//
    


#Produce listing of all items being advertised on the site

#Produce a list of Transactions by ItemName or By UserName
...
#Produce a list of all customers who have purchased a particular Month
#Produce a list of all items being sold for a given company
